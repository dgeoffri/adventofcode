...
def main():
	...
	combinedsteps = [wirelocations[0].index(i) + 1 + wirelocations[1].index(i) + 1 for i in list(crossings)]
	print "Closest intersection by number of combined steps requires {} steps.".format(min(combinedsteps))
